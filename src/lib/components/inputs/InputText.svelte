<script>
	import { areEqualStrings, getStore, waitFor } from "$lib/js/client/util.client";
	...
	const lang = getStore('lang'), bigScreen = getStore("bigScreen")
...
>
	<div class="input-wrapper p-r">
		...
		<label class="input-label p-none p-a p-c f-w-700" for={name}>
